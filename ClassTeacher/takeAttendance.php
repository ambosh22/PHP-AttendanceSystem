                                ...
                                <form id="attendanceForm_<?php echo $students[0]['classId'] . '_' . $students[0]['classArmId']; ?>" method="post">
                                    ...
                                    <table class="table align-items-center table-flush table-hover">
                                        ...
                                        <tfoot>
                                            <tr>
                                                <td colspan="4">Total Present:</td>
                                                <td id="presentCount_<?php echo $students[0]['classId'] . '_' . $students[0]['classArmId']; ?>"></td>
                                            </tr>
                                            <tr>
                                                <td colspan="4">Total Absent:</td>
                                                <td id="absentCount_<?php echo $students[0]['classId'] . '_' . $students[0]['classArmId']; ?>"></td>
                                            </tr>
                                        </tfoot>
                                    </table>
                                    <br>
...
$(document).ready(function() {
    ...
    $('.takeAttendanceBtn').click(function() {
        ...
        // Store checked student admission numbers in localStorage
        localStorage.setItem('attendance_' + formId, JSON.stringify(checkedStudents));
    ...
    $('.printAttendanceBtn').click(function() {
        ...
        var storedAttendance = localStorage.getItem('attendance_' + classId + '_'+ classArmId);
        if (storedAttendance) {
            ...
            checkedStudents.forEach(function(admissionNumber) {
                ...
                tableHtml += "<td>" + new Date().toISOString().split('T')[0] + "</td>";
                tableHtml += "</tr>";
                cnt++;
            });
